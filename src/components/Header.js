...
function Header(props) {
    return (
        <div style={{ width:'100%', background:'rgb(9,17,8)'}}>
<menu style={{display:'flex', alignItems:"center" , justifyContent:'space-evenly', height:'60px',margin:'0px', textDecoration:'none'}}>
