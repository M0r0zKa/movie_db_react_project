...
export const getMovies = createAsyncThunk(
    ...
    async function (id, {rejectWithValue}) {
        const response = await fetch(`https://api.themoviedb.org/3/discover/movie?api_key=949e143f769d41b678bb117fb5ce5494&language=ru&sort_by=popularity.desc&include_adult=false&include_video=true&page=${id}&with_watch_monetization_types=flatrate`)
